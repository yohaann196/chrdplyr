...
def normalize_notes(notes):
    return sorted(set(note_to_semitone(n) % 12 for n in notes))
...
def play_chord(notes, duration=1.2, amp=0.3):
    waves = []
    for n in notes:
        ...
        waves.append(generate_sine(freq, duration, amp))
